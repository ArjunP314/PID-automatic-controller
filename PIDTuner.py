...
class PIDtuner: 
  ...
  def _get_gradient(self, delta=0.01) -> (float, float, float):
    """Returns the gradient of themean squared error of the Simulations with respect to each kp, ki, and kd value.
    Arguments:
