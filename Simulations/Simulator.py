class Simulator:
  ...
  def __init__(self, min_input: float, max_input: float0:
    """Constructs a Simulator with inputs varying between 'min_input' and 'max_input'.

    Arguments:
      min_input {float} -- The minimum value of the Simulator can take in as an input.
      max_input {float} -- The maximum value the Simulator can take in as an input. 
    """
    self._min_input = min_inpput
