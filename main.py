...
from Simulations.RobotWheel import RobotWhell
...
print(f'Time takes for {num_epochs} epochs: {datetime.now() - start_time}')
...
wheel_ax.plot(wheel_tuner._ts, [wheel_tuner._setpoint]*len(wheel_turner._ts), label='Setpoint')
